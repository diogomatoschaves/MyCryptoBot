...
processed_historical_data_5m_2 = [
    {
        "open_time": Timestamp("2023-09-01 14:00:00+0000", tz="UTC"),
        "close_time": Timestamp("2023-09-01 14:04:59.999000+0000", tz="UTC"),
        "open": 55306.46,
    ...
    {
        "open_time": Timestamp("2023-09-01 14:20:00+0000", tz="UTC"),
        "close_time": Timestamp("2023-09-01 14:24:59.999000+0000", tz="UTC"),
        "open": 55306.46,
        "high": 55399.68,
        "low": 55217.22,
        "close": 55388.96,
...
processed_historical_data_1h = [
    ...
    {
        "open_time": Timestamp("2023-09-01 15:00:00+0000", tz="UTC"),
        "close_time": Timestamp("2023-09-01 15:59:59.999000+0000", tz="UTC"),
        "open": 55306.46,
        "high": 55399.68,
        "low": 55217.22,
        "close": 55388.96,
    ...
    {
        "open_time": Timestamp("2023-09-01 16:00:00+0000", tz="UTC"),
        "close_time": Timestamp("2023-09-01 16:59:59.999000+0000", tz="UTC"),
        "open": 55306.46,
        "high": 55399.68,
        "low": 55217.22,
        "close": 55388.96,
    ...
    {
        "open_time": Timestamp("2023-09-01 17:00:00+0000", tz="UTC"),
...
exchange_data_1 = dict(
    exchange_id="binance",
    symbol_id="BTCUSDT",
    open_time=datetime(2023, 9, 1, 10, tzinfo=pytz.utc),
    close_time=datetime(2023, 9, 1, 11, tzinfo=pytz.utc),
    interval="1h",
    open=1,
    high=1,
    low=1,
...
exchange_data_2 = dict(
    exchange_id="binance",
    symbol_id="BTCUSDT",
    open_time=datetime(2023, 9, 1, 11, tzinfo=pytz.utc),  # different open_time
    close_time=datetime(2023, 9, 1, 12, tzinfo=pytz.utc),  # different close_time
    interval="1h",
    open=1,
    high=1,
    low=1,
...
exchange_data_3 = dict(
    exchange_id="binance",
    symbol_id="BTCUSDT",
    open_time=datetime(2023, 9, 1, 12, tzinfo=pytz.utc),
    close_time=datetime(2023, 9, 1, 13, tzinfo=pytz.utc),
    interval="1h",
    open=1,
    high=1,
    low=1,
...
STRATEGIES = {
    ...
    "Momentum": {"name": "Momentum", "params": ["window"], "optionalParams": []},
