...
def mock_get_data(mocker):
    return mocker.patch('model.strategies._strategies.get_data')


@pytest.fixture()
def mock_trigger_order(mocker):
    return mocker.patch('model.strategies._strategies.trigger_order')


@pytest.fixture()
def mock_execute_order(mocker):
    return mocker.patch('model.strategies._strategies.execute_order')
